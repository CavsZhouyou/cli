 ...
 * @Descriptions: npm 单例的初始化
 * @TodoList: 无
 * @Date: 2021-03-22 21:01:03 
 * @Last Modified by: xiaotian@tangping
 * @Last Modified time: 2021-04-13 21:09:19
 */
...
const npm = module.exports = new class extends EventEmitter {
  ...
  /**
   * 主要做了命令运行前的参数和环境检查，最终调用的是命令 impl 的 exec 方法
   *
   * @param {*} cmd
   * @param {*} impl
   * @param {*} args
...
// 如果该文件作为 Node.js 进程启动时加载的入口脚本，则通过 cli 来启动命令行
