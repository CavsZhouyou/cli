 ...
 * @Descriptions: 提供方法判断 npm 不支持的 node 版本
 * @TodoList: 无
 * @Date: 2021-03-18 20:28:20 
 * @Last Modified by: xiaotian@tangping
 * @Last Modified time: 2021-04-08 20:23:33
 */
...
const checkVersion = exports.checkVersion = version => {
  ...
  // 格式化 version ，去掉 beta 版本号部分
  const versionNoPrerelease = version.replace(/-.*$/, '')

  // 通过 semver 检查 npm 支持的 node 版本范围
  return {
